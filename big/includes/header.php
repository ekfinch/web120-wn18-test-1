...
<div class="wrapper">
<header>
  <h1><a href="index.php"><i class="<?=$logo?>" aria-hidden="true"></i> Erica Finch: Web Development Examples</a></h1>
  <nav id="cssmenu">
  <ul>
     <li><a href="../index.php"><span><i class="fa fa-fw fa-camera-retro"></i> WEB120 Portal</span></a></li>
     <li><a href="index.php"><span><i class="fa fa-fw fa-anchor"></i> Home</span></a></li>
