...
#EDIT THE FOLLOWING:
$toAddress = "efinch76@gmail.com";  //place your/your client's email address here
$toName = "Erica Finch"; //place your client's name here
$website = "ericafinch.com";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        <h2>Thank you for your interest in our web services! We will respond to you within 2 business days.</h2>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
